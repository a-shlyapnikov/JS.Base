...
document.addEventListener('click', (e) => {
    if (e.target.classList.contains('super_element')) {
        ...
        console.log(`Класс не 'super_element' присутствует в элементе ${e.target.tagName.toLowerCase()}`);
    }
});

// 4. Сделайте, чтобы при наведении на textarea в консоли появлялось сообщение: "Вы навели на textarea."

document.querySelector('textarea').addEventListener('mouseover', (e) => {
...
// Ответ: это связано с тем, что сначала будет выполнятся обработчик на списке ul, а после уже на document, 
// потому что сначала выполняются обработчики событий вложенных элементов, а потом их родителей
